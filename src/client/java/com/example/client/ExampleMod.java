...
public class ExampleMod implements ClientModInitializer {
            ...
            while (toggleKey.wasPressed()) {
                ...
                if (enabled) {
                    client.player.sendMessage(
                            Text.literal("[AutoCore] Auto Scanner ON"),
                            true
                    );
                } else {
                    client.player.sendMessage(
                            Text.literal("[AutoCore] Auto Scanner OFF"),
                            true
                    );
                }
            }
    ...
    private void scanVaults(MinecraftClient client) {
        ...
        for (BlockPos pos : BlockPos.iterate(min, max)) {
            ...
            if (client.interactionManager != null) {
                ...
                client.player.sendMessage(
                        Text.literal(
                                "[AutoCore] Heavy Core Vault found!"
                        ),
                        true
                );
